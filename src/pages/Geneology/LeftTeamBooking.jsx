  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-800">Left Team Plot Bookings</h1>
          <p className="text-gray-500 mt-1">View all plots booked by your left team members</p>
        </div>
